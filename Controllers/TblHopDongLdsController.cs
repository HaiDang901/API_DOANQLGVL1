...
namespace DOAN5.Controllers
{
    ...
    [ApiController]
    public class TblHopDongLdsController : ControllerBase
    {
        private readonly SchoolmanagementContext _context;

        public TblHopDongLdsController(SchoolmanagementContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.TblHopDongLd.ToListAsync();
        }
        ...
        {
            var tblHopDongLd = await _context.TblHopDongLd.FindAsync(id);
        ...
        {
            _context.TblHopDongLd.Add(tblHopDongLd);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<TblHopDongLd>> DeleteTblHopDongLd(long id)
        {
            ...
            _context.TblHopDongLd.Remove(tblHopDongLd);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.TblHopDongLd.Any(e => e.MaHd == id);
        }
    }
}
