...
namespace DOAN5.Controllers
{
    ...
    public class GiaoVienChuNhiemsController : ControllerBase
    {
        ...
        public GiaoVienChuNhiemsController(SchoolmanagementContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.TblGiaoVienChuNhiem.ToListAsync();
        }
        ...
        {
            var tblGiaoVienChuNhiem = await _context.TblGiaoVienChuNhiem.FindAsync(id);
        ...
        public async Task<ActionResult<TblGiaoVienChuNhiem>> DeleteTblGiaoVienChuNhiem(long id)
        {
            ...
            _context.TblGiaoVienChuNhiem.Remove(tblGiaoVienChuNhiem);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.TblGiaoVienChuNhiem.Any(e => e.MaGvcn == id);
        }
    }
}
